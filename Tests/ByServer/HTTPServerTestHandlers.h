...
public:
	RootHandler(const char * segment):IHTTPHandler(segment,SUPPORT_NONE){};
	HANDLERSTYPES GetMyHandlerType() { return HANDLER_STATIC; }
};
...
public:
	OnCreateHandler(const char * segment):IHTTPHandler(segment,SUPPORT_PUT){};
	HANDLERSTYPES GetMyHandlerType() { return HANDLER_STATIC; }
private:
	virtual void OnCreate(NPT_HttpRequest& request, const NPT_HttpRequestContext& context,NPT_HttpResponse& response);
};
...
public:
	ErrorHandler(const char * segment):IHTTPHandler(segment,SUPPORT_PUT){};
	HANDLERSTYPES GetMyHandlerType() { return HANDLER_STATIC; }
private:
	virtual void OnRead  (NPT_HttpRequest& request, const NPT_HttpRequestContext& context,NPT_HttpResponse& response);
};
...
public:
	OnReadHandler(const char * segment):IHTTPHandler(segment,SUPPORT_GET){};
	HANDLERSTYPES GetMyHandlerType() { return HANDLER_STATIC; }
private:
	virtual void OnRead  (NPT_HttpRequest& request, const NPT_HttpRequestContext& context,NPT_HttpResponse& response);
};
...
public:
	OnUpdateHandler(const char* segment):IHTTPHandler(segment,SUPPORT_POST){};
	HANDLERSTYPES GetMyHandlerType() { return HANDLER_STATIC; }
private:
...
public:
	OnDeleteHandler(const char *   segment):IHTTPHandler(segment,SUPPORT_DELETE){};
	HANDLERSTYPES GetMyHandlerType() { return HANDLER_STATIC; }
private:
...
public:
	OnAllHandler(const char *   segment):IHTTPHandler(segment ,SUPPORT_ALL){};
	HANDLERSTYPES GetMyHandlerType() { return HANDLER_STATIC; }
private:
	virtual void OnCreate(NPT_HttpRequest& request, const NPT_HttpRequestContext& context,NPT_HttpResponse& response);
 	virtual void OnRead  (NPT_HttpRequest& request, const NPT_HttpRequestContext& context,NPT_HttpResponse& response);
