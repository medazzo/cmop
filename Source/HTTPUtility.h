...
+---------------------------------------------------------------------*/
Result
MapNPTResult(NPT_Result result)
{
    switch (result) {
        case NPT_SUCCESS: return CMOP_SUCCESS;
        case NPT_FAILURE: return CMOP_ERROR;
        case NPT_ERROR_INVALID_PARAMETERS: return CMOP_NOTDEFINED_RESULT;
        case NPT_ERROR_PERMISSION_DENIED: return CMOP_NOTDEFINED_RESULT;
        case NPT_ERROR_OUT_OF_MEMORY: return CMOP_NOTDEFINED_RESULT;
        case NPT_ERROR_NO_SUCH_NAME: return CMOP_NOTDEFINED_RESULT;
        case NPT_ERROR_NO_SUCH_PROPERTY: return CMOP_NOTDEFINED_RESULT;
        case NPT_ERROR_NO_SUCH_ITEM: return CMOP_NOTDEFINED_RESULT;
        ...
        default: return CMOP_UNKNOWN_RESULT;
    }
