...
/*----------------------------------------------------------------------
 |   constants
 +---------------------------------------------------------------------*/
const int HTTPUtility::HTTP_DEFAULT_MAX_THREADS_WORKERS = 10;
const int HTTPUtility::HTTP_SERVER_PORT_NUMBER = 8080;
const char *HTTPUtility::HTTP_SERVER_NAME_VERSION_NUMBER = "CMOP/V0.0.1";
const char *HTTPUtility::APP_SERVER_NAME = "CMOP-SRV";

const char *HTTPUtility::HTTP_DEFAULT_403_HTML =
		"<html><head><title>403 Forbidden</title></head><body><h1>Forbidden</h1><p>Access to this URL is forbidden.</p></html>";/*!< default HTTPServer response  in  case of 403 Error  */
const char *HTTPUtility::HTTP_DEFAULT_404_HTML =
		"<html><head><title>404 Not Found</title></head><body><h1>Not Found</h1><p>The requested URL was not found on this server.</p></html>";/*!< default HTTPServer response  in  case of 404 Error  */
const char *HTTPUtility::HTTP_DEFAULT_500_HTML =
		"<html><head><title>500 Internal Error</title></head><body><h1>Internal Error</h1><p>The server encountered an unexpected condition which prevented it from fulfilling the request.</p></html>";/*!< default HTTPServer response  in  case of 500 Error  */

/*----------------------------------------------------------------------
 |   HTTPUtility::MapNPTResult
 +---------------------------------------------------------------------*/
Result HTTPUtility::MapNPTResult(NPT_Result result) {
	switch (result) {
	case NPT_SUCCESS:
		return CMOP_SUCCESS;
	case NPT_FAILURE:
